...
Models were trained with stochastic gradient descent with Nesterov's momentum on minibatches of 20 subsequences, each with 40 characters.\todof{Trenovani druheho modelu.} After couple of hours, models were producing following samples:
...
\todo[inline]{Co ocekavam od navrhu modelu? Co se tady v te zprave delo?}
%=========================================================================
