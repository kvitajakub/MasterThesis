...
Model used one-hot encoding for the input and probability distribution of the next character in sequence as an output. First network has three recurrent LSTM layers, each with 400 nodes, followed by linear and logarithmic softmax layer. \todof{Druhy model.} Architectures are on the images \ref{fig:chargen1} and \ref{fig:chargen2}.
...
\begin{figure}[htb]
	...
	\hfill
	\begin{minipage}{.48\textwidth}
		\missingfigure{Architektura 2}
%	\includegraphics[width=\textwidth]{./fig/long-term-rec-con.pdf}
		\caption{MISSING CAPTION
			\label{fig:chargen2}}
	\end{minipage}
\end{figure}

Models were trained with stochastic gradient descent with Nesterov's momentum on minibatches of 20 subsequences, each with 40 characters. After couple of hours, models were producing following samples:
...
\todo[inline]{Co ocekavam od navrhu modelu?}
%=========================================================================
