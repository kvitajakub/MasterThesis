...
Second approach is called \emph{BeamSearch}, which iteratively considers the set of the $ k $ best sentences up to time $ t $ as candidates to generate sentences of size $ t + 1 $, and keep only the resulting best $ k $ of them. This method can provide better results, but in this thesis, only \emph{Sampling} was used.
