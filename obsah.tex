...
\begin{figure}[!t]
	...
	\caption{Architecture of famous convolutional net LeNet-5.~\cite{lecun-98}
		\label{fig:lenet}}
\end{figure}
...
\begin{figure}[!t]
	...
	\caption{\textquoteleft From Captions to Visual Concepts\textquoteright\ caption generation process.~\cite{DBLP:journals/corr/FangGISDDGHMPZZ14}
