...
\todo[fancyline]{Make a cake \ldots}
Pøehled základù typografie a tvorby dokumentù s vyu¾itím systému\todo[fancyline]{Make a cake \ldots} \LaTeX je 
uveden v~\cite{Rybicka}.

\section{Musíme mít co øíci}
Dal¹ím dùle¾itým pøedpokladem dobrého psaní je {\it psát pro nìkoho}. Pí¹eme-li si poznámky sami pro sebe, pí¹eme je jinak ne¾ \todo[fancyline]{Make a cake \ldots}výzkumnou zprávu, èlánek, diplomovou práci, knihu nebo dopis. Podle pøedpokládaného ètenáøe se rozhodneme pro zpùsob psaní, rozsah informace a~míru detailù.

\section{Musíme vìdìt, komu to chceme øíci}
Dal¹ím dùle¾itým pøedpokladem dobrého psaní je psát pro nìkoho. Pí¹eme-li si poznámky sami pro sebe, pí¹eme je jinak ne¾ výzkumnou zprávu, èlánek, dipl\todo[fancyline]{Make a cake \ldots}omovou práci, knihu nebo dopis. Podle pøedpokládaného ètenáøe se rozhodneme pro zpùsob psaní, rozsah informace a~míru detailù.
