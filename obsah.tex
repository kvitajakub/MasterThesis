...
Loss function used in this work is the sum of the negative log likelihood of the correct character at each step as follows:
\begin{align}
...
\todo[inline]{Jakou pouzivam loss funkci. - rovnice - bez obrazku, pak s obrazkem.- minimizing negative log likelihood}
...
\todo[inline]{Jak se generovaly vety. Normalne samplovanim z  probability distribution. jednoduche rozsireni by bylo pridat pojem teploty, ale neni to potreba protoze to generovalo dobre.}
