...
\todo[inline]{There are several types of neurons, each of them with special behavior, like in brain. In this part I will describe few popular options, which are used later in the text. I selected neurons from different families, because many of them have multiple variations with similar approach.}
