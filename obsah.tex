...
\todo[inline]{Vice popsat co bude v teto sekci a druha cast o language modelech atd..}

	\subsection{Recurrent units}\label{subsec:recUnits}

	\todo[inline]{Nejaky uvod o tom ze jsou ruzne druhy neuronu... O tom ze se vetsinou pouzivaji komplikovane, opatrne navrhnute unity protoze zvladnou vice nez jednoducha vanilla rekurentni architektura.}
